                ...
                <div className="founder-main__private-info">
                    {editInfo && userData ? (
                        <form className='signup-startup__form'>
                            ...
                            <h3 className='signup-startup__form-subtitle'>Buyers will see this after you give
                                access</h3>

                            <label className='signup__label'>
                                <span>Contact name </span>
                                <input className='signup__input' name='contact_name' type='text'
                                       value={userData.contact_name}
                                       onChange={handleUserData}/>
                            </label>
                            <label className='signup__label'>
                                <span>Startup name </span>
                                <input className='signup__input' name='startup_name' type='text'
                                       value={userData.startup_name}
                                       onChange={handleUserData}/>
                            </label>
                            <label className='signup__label'>
                                <span>Contact Email </span>
                                <input className='signup__input' name='contact_email' type='email'
